...
var paths = {
  ...
  init: function() {
    ...
    this.dist.assets     = this.dist.root + '/assets';
...
gulp.task("build",["assets",'files', 'styles', 'scripts', 'templates']);
gulp.task('default', ['watch', 'serve', 'assets', 'files', 'styles', 'scripts', 'templates']);
